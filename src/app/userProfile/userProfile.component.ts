...
export class UserProfileComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.userProfileService.getTagCategories().subscribe((data: TagCategories[])=>{
      this.googleAnalyticsService.eventEmitter("userProfile-init", "userProfile", "init", "getTagCategories", 1,this.credentialsService.credentials.id);
    ...
    this.userProfileService.getTagDetails().subscribe((data: Map<string, TagDetails[]>)=>{
      this.googleAnalyticsService.eventEmitter("userProfile-init", "userProfile", "init", "getTagDetails", 1,this.credentialsService.credentials.id);
